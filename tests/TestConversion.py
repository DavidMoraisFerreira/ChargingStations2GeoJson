...
class TestConversion(unittest.TestCase):
    ...
    def test_mismatched_connector_count(self):
        ...
        self.assertRaises(ValueError, ChargingStations2osm.extract_data_from_kml,
